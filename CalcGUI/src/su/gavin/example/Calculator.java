...
/**
 * Created by gavinsu on 23/11/16.
 */
public class Calculator {
    ...
    public Calculator() {
        ...
        pointBtn.addActionListener(new PointBtnClicked());
    }
    ...
    private class PointBtnClicked implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent e) {
